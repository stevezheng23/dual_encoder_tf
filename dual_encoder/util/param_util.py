...
def create_default_hyperparams(config_type):
    ...
    if config_type == "default":
        hyperparams = tf.contrib.training.HParams(
            ...
            data_src_word_sos="<sos>",
            data_src_word_eos="<eos>",
            ...
            data_trg_word_sos="<sos>",
            data_trg_word_eos="<eos>",
            ...
            model_representation_char_embed_dim=16,
            ...
            model_interaction_src2trg_enable=True,
            ...
            model_matching_task_type="similarity",
            model_matching_loss_type="log_loss",
            device_num_gpus=1,
